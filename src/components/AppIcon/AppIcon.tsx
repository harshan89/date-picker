...
export const CalenderDoubleArrow = createIcon({
  ...
  viewBox: '0 0 14 12',
  path: [
    <path key={3} d='M7.2896 12L13.0827 6L7.2896 0L5.92822 1.41L10.3503 6L5.92822 10.59L7.2896 12Z' fill='#8C8C8C' />,
    <path key={4} d='M2.2896 12L8.08271 6L2.2896 0L0.928223 1.41L5.35029 6L0.928223 10.59L2.2896 12Z' fill='#8C8C8C' />,
  ],
})
