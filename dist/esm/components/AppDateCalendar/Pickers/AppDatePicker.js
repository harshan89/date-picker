...
var AppDatePicker = function (_a) {
    ...
    return (React.createElement(ChakraProvider, { theme: theme },
        ...
        React.createElement(Box, { as: motion.div, initial: { opacity: 0, scale: 0.5, x: -100 }, animate: { opacity: 1, scale: 1, x: 0 }, transition: '.1s' },
            React.createElement(Box, { onClick: function (e) { return onCalenderIconClick(e); }, cursor: 'pointer' }, icon),
