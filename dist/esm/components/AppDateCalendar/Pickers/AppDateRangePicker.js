...
var AppDateRangePicker = function (_a) {
    var children = _a.children, id = _a.id, onRangeSelect = _a.onRangeSelect, validMaxDate = _a.validMaxDate, _b = _a.initialDate1, initialDate1 = _b === void 0 ? addMonths(new Date(), -1) : _b, _c = _a.initialDate2, initialDate2 = _c === void 0 ? new Date() : _c, prePos = _a.prePos;
    ...
    React.createElement(Box, { cursor: 'pointer', ref: ref, zIndex: 1 },
        React.createElement(Box, { onClick: onCalenderIconClick }, children),
